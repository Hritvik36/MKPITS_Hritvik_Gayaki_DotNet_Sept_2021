...
Alter table Category(Id int primary key identity(10,1),catname varchar(20) unique check  (catname in ('soap','shampoo','detergent','oil','handwash','grain','biscuits','pulses','edible oil'));
